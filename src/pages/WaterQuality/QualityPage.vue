<template>
    <div class="Quality">
      <v-main>
        ...
        <v-navigation-drawer v-model="isLeftDrawerOpen" location="left" :width="250">
          ...
          <template v-if="activeLeftTab === 'layers'">
            ...
            <v-select
              ...
              multiple
              clearable
              v-model="adminBoundary"
              :items="adminBoundaryLayers"
        ...
        <!-- Map -->
        <div ref="qualityRef" style="height: 86vh">
          <QualityComponent />
        </div>
        ...
        <v-navigation-drawer v-model="isRightDrawerOpen" location="right" :width="300">
          ...
          <div v-if="activeTool === 'search'">
            ...
            <v-divider :thickness="3"></v-divider>
            <v-img
              src="../GangaBasin/rightPng/search_button.png"
              style="margin-top: 100px; opacity: 0.8"
              contain
              alt="Comparison Tool Image"
            ></v-img>
          </div>
            ...
            <v-card elevation="0">
              ...
              <v-card-text>
                ...
                <v-switch
                  ...
                  color="purple"
                  label="Enable Feature Info for Raster"
                ></v-switch>
              </v-card-text>
            </v-card>
            <v-divider :thickness="3"></v-divider>
            <v-img
              src="../GangaBasin/rightPng/feature_tool.png"
              style="margin-top: 70px; opacity: 0.8"
              contain
              alt="Comparison Tool Image"
            ></v-img>
          </div>
          ...
          <div v-else-if="activeTool === 'measurement'">
                ...
                <v-container class="icon-container" justify="center">
                  <v-row justify="center">
                    <v-col cols="4" class="text-center">
                      <v-btn
                        :color="activeMeasurement === 'Length' ? 'blue' : ''"
                        prepend-icon="mdi-pulse"
                        stacked
                        @click="activateMeasurement('Length')"
                        >Length</v-btn
                      >
                    </v-col>
                    <v-col cols="4" class="text-center">
                      <v-btn
                        :color="activeMeasurement === 'Area' ? 'blue' : ''"
                        prepend-icon="mdi-pentagon-outline"
                        stacked
                        @click="activateMeasurement('Area')"
                        >Area</v-btn
                      >
                    </v-col>
                    <v-col cols="4" class="text-center">
            ...
            <v-divider :thickness="3"></v-divider>
            <v-img
              src="../GangaBasin/rightPng/measure_tool.png"
              style="margin-top: 50px; opacity: 0.8"
              contain
              alt="Comparison Tool Image"
            ></v-img>
          </div>
          ...
          <div v-else-if="activeTool === 'compare'">
            <v-card elevation="0">
              ...
              <v-card-text>
                ...
                <v-select
                  ...
                  label="Please Select a Layer"
                ></v-select>
                <v-btn :disabled="!isBothSelected || showError" @click="handleCompare"
                  >Compare</v-btn
                >
                <div v-if="showError" class="text-red text-caption mt-2">
            ...
            <v-divider :thickness="3"></v-divider>
            <v-img
              src="../GangaBasin/rightPng/compare_tool.png"
              style="margin-top: 80px; opacity: 0.9"
              max-height="300"
              contain
              alt="Comparison Tool Image"
            ></v-img>
  ...
  <script>
  import QualityComponent from "@/pages/WaterQuality/QualityComponent.vue";
